...
humandate: "Oct 24-30, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2022-10-30        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
...
etherpad:  https://pad.carpentries.org/2022-10-24-ttt-NWU-Online # optional: URL for the workshop Etherpad if there is one
...
This is an online event. We will meet using the online videoconference software Zoom. You will need to <a href="https://zoom.us/download">download and install their client</a> to connect with your instructors. The link to use for this event is <{{ loc.address }}> use "<b>202020</b>" as meeting passcode.
...
Pleaes use this <a href ="[https://forms.gle/ydfD1Z4XBnc38vaV6](https://docs.google.com/forms/d/e/1FAIpQLScpVIlfXJzHGTqv74ZD0ezIzJT6QXwir84mukiV1xxyjK6WFA/viewform?vc=0&c=0&w=1&flr=0)"><b>application form</b></a>.
